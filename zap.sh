...
echo "parse result.html - add indices"
cat result.html | jq -c '.[] | {"index": {"_index": "zapindex", "_type": "zapindex",  "_id": "_id"}}, .' | curl -H 'Content-Type: application/json'   -XPOST esurl/_bulk --data-binary @-
