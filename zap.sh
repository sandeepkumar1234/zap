...
cat result.json | jq -c '.[] | {"index": {"_index": "zapindex", "_type": "zapindex",  "_id": "_id" ,"testplanId": "sandeep"}}, .' | curl -H 'Content-Type: application/json'   -XPOST esurl/_bulk --data-binary @-
